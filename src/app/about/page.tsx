    ...
    <main className="flex flex-1 flex-col items-center px-6 py-24">
      <div className="flex w-full max-w-2xl flex-col gap-6">
        ...
        <div className="flex flex-col gap-4 text-lg text-muted-foreground">
          ...
          <p>
            An international youth exchange in İscar, Spain, was a different
            kind of lesson — the best analysis still has to be explained to
            people who care about the conclusion, not the model.
          </p>
          <p>
